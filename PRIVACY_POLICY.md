FootballGeek: Privacy policy
Welcome to the FootballGeek app for Android!

This is an open source Android app developed by jeffin johny. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
